...
/**
 * Registers post type vcv_yoast_panel for custom edit form attribute gutenberg
 *
 * Class removeUiMetaboxes
 * @package VisualComposer\Modules\Vendors\Gutenberg
 */
class YoastPanelController extends Container implements Module
{
     ...
     * @var string
     */
    protected $postTypeSlug = 'vcv_yoast_panel';
    ...
    {
        $labels = [
            'name' => _x('Yoast attrs', 'Post type general name', 'visualcomposer'),
